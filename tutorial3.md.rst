...
A continuación se presenta el mismo ejemplo del tutorial anterior de una
...
acceso a los datos, y *controlador de página* para la capa de
presentación.
...
*universidad.db* y debe estar ubicada en el directorio
*/tutorial3/database/*. El código SQL utilizado para generar la tabla de
profesores sería el siguiente:
...
tabla de datos*. Para ello es necesario crear una clase abstracta que se
...
definida en un archivo *compileData.bat* residente en el directorio
*/tutorial3* (todo en una sola línea):
...
se utiliza la *pasarela a tabla de datos* mostrada anteriormente.

La única clase necesaria sería la llamada *ProfesorModule.java* y
residirá en el directorio */tutorial3/src/domain/*.
...
del framework *Spring 3* (como se indicó antes). La siguiente
instrucción para ejecutar la compilación puede estar definida en un
archivo *compileDomain.bat* residente en el directorio */tutorial3/*
...
El servicio de la root ha sido implementado mediante *controladores de
página*, en donde cada página se implementa como un controlador
individual. La clase general para definir los controladores se llama
*PageController.java* y debe residir en el directorio
*/tutorial3/src/display/*.
...
mismo directorio */tutorial3/src/display/*.
...
el siguiente código y y reside en el directorio */tutorial3/root/*.:
...
*/tutorial3/src/display/*. Es importante observar la utilización del
...
*/tutorial3/root/WEB-INF/lib/*. La siguiente instrucción para ejecutar
la compilación puede estar definida en un archivo *compileDisplay.bat*
residente en el directorio */tutorial3/* (todo en una sola línea):
...
*web.xml* y deben residir en el directorio */tutorial3/root/WEB-INF/*.
...
*winstone-0.9.10.jar* y copiarlo en el directorio */tutorial3/*. Sin
...
en el directorio */tutorial3/lib*:
